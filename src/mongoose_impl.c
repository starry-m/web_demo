...
struct attribute s_leds_attributes[] = {
        {"led1_sate", "bool", NULL, offsetof(struct leds, led1_sate), 0, false},
        {"led2_sate", "bool", NULL, offsetof(struct leds, led2_sate), 0, false},
        {"led3_sate", "bool", NULL, offsetof(struct leds, led3_sate), 0, false},
        {"led4_sate", "bool", NULL, offsetof(struct leds, led4_sate), 0, false},
        {"led1_mode", "int", NULL, offsetof(struct leds, led1_mode), 0, false},
        {"led2_mode", "int", NULL, offsetof(struct leds, led2_mode), 0, false},
        {"led3_mode", "int", NULL, offsetof(struct leds, led3_mode), 0, false},
        {"led4_mode", "int", NULL, offsetof(struct leds, led4_mode), 0, false},
        {"led1_blink_frequency", "int", NULL, offsetof(struct leds, led1_blink_frequency), 0, false},
        {"led2_blink_frequency", "int", NULL, offsetof(struct leds, led2_blink_frequency), 0, false},
        {"led3_blink_frequency", "int", NULL, offsetof(struct leds, led3_blink_frequency), 0, false},
        {"led4_blink_frequency", "int", NULL, offsetof(struct leds, led4_blink_frequency), 0, false},
