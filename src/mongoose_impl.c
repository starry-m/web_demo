...
struct attribute s_led_1_attributes[] = {
  {"sate", "bool", NULL, offsetof(struct led_1, sate), 0, false},
  {"mode", "int", NULL, offsetof(struct led_1, mode), 0, false},
  {"blink_delay_on", "int", NULL, offsetof(struct led_1, blink_delay_on), 0, false},
  {"blink_delay_off", "int", NULL, offsetof(struct led_1, blink_delay_off), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_led_2_attributes[] = {
  {"sate", "bool", NULL, offsetof(struct led_2, sate), 0, false},
  {"mode", "int", NULL, offsetof(struct led_2, mode), 0, false},
  {"blink_delay_on", "int", NULL, offsetof(struct led_2, blink_delay_on), 0, false},
  {"blink_delay_off", "int", NULL, offsetof(struct led_2, blink_delay_off), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_led_3_attributes[] = {
  {"sate", "bool", NULL, offsetof(struct led_3, sate), 0, false},
  {"mode", "int", NULL, offsetof(struct led_3, mode), 0, false},
  {"blink_delay_on", "int", NULL, offsetof(struct led_3, blink_delay_on), 0, false},
  {"blink_delay_off", "int", NULL, offsetof(struct led_3, blink_delay_off), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_led_4_attributes[] = {
  {"sate", "bool", NULL, offsetof(struct led_4, sate), 0, false},
  {"mode", "int", NULL, offsetof(struct led_4, mode), 0, false},
  {"blink_delay_on", "int", NULL, offsetof(struct led_4, blink_delay_on), 0, false},
  {"blink_delay_off", "int", NULL, offsetof(struct led_4, blink_delay_off), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_state_attributes[] = {
  {"cpu", "int", NULL, offsetof(struct state, cpu), 0, false},
  {"mem", "int", NULL, offsetof(struct state, mem), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
static struct apihandler s_apihandlers[] = {
  {"led_1", "object", false, 3, 3, 0UL, s_led_1_attributes, (void (*)(void *)) glue_get_led_1, (void (*)(void *)) glue_set_led_1, NULL, NULL, NULL, NULL, NULL, NULL, sizeof(struct led_1)},
  {"led_2", "object", false, 3, 3, 0UL, s_led_2_attributes, (void (*)(void *)) glue_get_led_2, (void (*)(void *)) glue_set_led_2, NULL, NULL, NULL, NULL, NULL, NULL, sizeof(struct led_2)},
  {"led_3", "object", false, 3, 3, 0UL, s_led_3_attributes, (void (*)(void *)) glue_get_led_3, (void (*)(void *)) glue_set_led_3, NULL, NULL, NULL, NULL, NULL, NULL, sizeof(struct led_3)},
  {"led_4", "object", false, 3, 3, 0UL, s_led_4_attributes, (void (*)(void *)) glue_get_led_4, (void (*)(void *)) glue_set_led_4, NULL, NULL, NULL, NULL, NULL, NULL, sizeof(struct led_4)},
